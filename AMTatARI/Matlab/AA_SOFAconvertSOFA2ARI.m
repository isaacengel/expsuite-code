function [hM,meta,stimPar]=AA_SOFAconvertSOFA2ARI(Obj)
% [hM,meta,stimPar]=AA_SOFAconvertSOFA2ARI(Obj) converts a SOFA structure to hM, meta, and stimPar (see ARI HRTF format).
%
...
if isfield(Obj,'ItemIndex'),
	meta.itemidx=bsxfun(@times,Obj.ItemIndex,ones(Obj.API.M,1));
end
